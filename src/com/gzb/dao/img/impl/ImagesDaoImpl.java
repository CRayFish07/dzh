...
import com.gzb.dao.img.ImagesDao;
import com.gzb.domain.img.Images;
import com.gzb.util.ImageUtils;
...
//			pstmt.setBinaryStream(5, new FileInputStream(images.getFile()), (int) images.getFile().length());
	...
	public List<Images> selectImagessByImages(Images images) {
		...
		StringBuffer sqlStr = new StringBuffer("select id,name,info,tag,date,imagetype,type,state from images where " + getSelectCommonParams());
